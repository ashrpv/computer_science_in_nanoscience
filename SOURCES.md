...
Приложенные презентации служат основой текстовых конспектов. Порядок модулей взят из плана курса в обсуждении «Сведения о дисциплине»: Python для научных данных → экспериментальные данные и воспроизводимость → планирование эксперимента и оптимизация → спектры, кривые и изображения → научное и стохастическое моделирование → классическое ML → от лаборатории к производству → итоговый проект.
