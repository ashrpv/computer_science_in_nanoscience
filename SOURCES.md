...
Первые десять тем основаны на исходных презентациях. Курс последовательно охватывает Python, воспроизводимость, планирование эксперимента, анализ измерений, научное моделирование, машинное обучение и переход к производству.

Это порядок изучения материалов, а не распределение аудиторных часов. В модуле планирования сначала рассматриваются планы и оптимизация, затем случайные эффекты и блочные планы. Лекции 13 и 14 созданы для производственного модуля; лекции 11–12 отведены под машинное обучение.
...
| 4 | `04_Лекция_python_4.pptx` | 38 | Добавлен [NumPy и визуализация](python_basics/04-numpy_and_visualization.md) |
...
| 13 | [Масштабирование и данные партий](slides/13_from_lab_to_production_scale_and_data.pptx) | 36 | [Новый конспект](production/13-scaling_and_process_data.md) |
| 14 | [Мониторинг, цифровой двойник и следующий опыт](slides/14_from_lab_to_production_monitoring_and_twin.pptx) | 36 | [Новый конспект](production/14-monitoring_and_digital_twin.md) |
...
На титуле файла `04_Лекция_python_4.pptx` написано «Лекция 5». В оглавлении он занимает четвёртое место согласно имени файла и последовательности предоставленного комплекта.
...
Пример процесса SiO₂ и численные значения в двух новых лекциях искусственные.
